...
public class BettingConsole {
    ...
    public void listTimeRanges(
            @ShellOption(defaultValue = NULL, value = {"-g", "--granularity"}, help = TIME_GRANULARITY) final TimeGranularity granularity) {
    ...
    public void listMarketCatalogue(
            @ShellOption(defaultValue = NULL, value = {"-mp", "--market-projection"}, help = MARKET_PROJECTION) final Set<MarketProjection> marketProjection,
            @ShellOption(defaultValue = NULL, value = {"-s", "--sort"}, help = MARKET_SORT) final MarketSort sort,
            @ShellOption(defaultValue = NULL, value = {"-mr", "--max-results"}, help = MAX_RESULTS) final Integer maxResults) {
