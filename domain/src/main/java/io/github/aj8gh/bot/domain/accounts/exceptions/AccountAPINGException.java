package io.github.aj8gh.bot.domain.accounts.exceptions;
...
public class AccountAPINGException extends RuntimeException {
    ...
    public AccountAPINGException(ErrorCode errorCode, String errorDetails, String requestUUID) {
        this.errorCode = errorCode;
        this.errorDetails = errorDetails;
        this.requestUUID = requestUUID;
    }

    public AccountAPINGException(String message, ErrorCode errorCode, String errorDetails, String requestUUID) {
        super(message);
        this.errorCode = errorCode;
        this.errorDetails = errorDetails;
        this.requestUUID = requestUUID;
    ...
    public enum ErrorCode {
        ...
        INVALID_SESSION_INFORMATION("The session token hasn't been provided, is invalid or has expired. You must login again to creata a new session token."),
        ...
        APP_KEY_CREATION_FAILED("Creating application key version has failed. Please check that your application name is unique and doesn't contain your Betfair username."),
        ...
        CUSTOMER_ACCOUNT_CLOSED("A token could not be created because the customer's account is CLOSED.");
