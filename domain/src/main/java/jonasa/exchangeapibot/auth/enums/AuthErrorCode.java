...
public enum AuthErrorCode {
    ...
    AUTHORIZED_ONLY_FOR_DOMAIN_ES("You are attempting to login to the Betfair Swedish domain with a non .es account."),
    ...
    NOT_AUTHORIZED_BY_REGULATOR("The user identified by the given credentials is not authorized due to the regulators' policies. Ex: the user for which this session should be created is not allowed to act(play, bet) in this jurisdiction."),
